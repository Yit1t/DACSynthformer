# Introduction
This is an assignment for the Computational Music Creativity class. Ada([@AdaSalvadorAvalos](https://github.com/AdaSalvadorAvalos)) and I explored what happens when we change different parameters of DACSynthformer, which was developed by Lonce Wyse. There are two branches in this repo: one contains our first and third attempts, and the other contains our second attempt.
